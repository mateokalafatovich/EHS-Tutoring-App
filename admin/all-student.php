...
?>
<h1 class="text-primary"><i class="fas fa-users"></i>  All Tutors<small class="text-warning"> List of Tutors</small></h1>
...
<?php if(isset($_GET['delete']) || isset($_GET['edit'])) {?>
  <div role="alert" aria-live="assertive" aria-atomic="true" class="toast fade" data-autohide="true" data-animation="true" data-delay="2000">
    <div class="toast-header">
      <strong class="mr-auto">Insert Tutor</strong>
...
{
   var conf = confirm('Are you sure you would like to delete? This operation is irreversible.');
   if(conf)
