            ...
            <div class="col-md-4 offset-md-4">
             	<form method="POST" action="">
				  ...
				  <div class="text-center">
				      <button type="submit" name="login" class="btn btn-warning">Log In (Tutors)</button>
					  <a class="btn btn-success" href="/matriculas">Tutor Search</a>
				    </div>
				    <p>If you do not have an account, you can <a href="register.php">register here</a></p>
				  </div>
				</form>
            </div>
          </div>
