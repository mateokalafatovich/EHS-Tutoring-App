...
<h1><a href="index.php"><i class="fas fa-tachometer-alt"></i>  Control Panel</a> <small>Dashboard</small></h1>
      ...
      <div class="card-header">
        <div class="row">
          ...
          <div class="col-sm-8">
            ...
            <div class="float-sm-right">All Tutors</div>
          </div>
        </div>
      </div>
      ...
      <div class="card-header">
        <div class="row">
          ...
          <div class="col-sm-8">
            ...
            <div class="clearfix"></div>
            <div class="float-sm-right">All Users</div>
          </div>
        </div>
      </div>
      <div class="list-group-item-primary list-group-item list-group-item-action">
      ...
      <div class="card-header">
        <div class="row">
          ...
          <div class="col-sm-6">
            ...
            <div class="clearfix"></div>
            <div class="float-sm-right">Hi, Hello</div>
          </div>
        </div>
      </div>
      <div class="list-group-item-primary list-group-item list-group-item-action">
